...
//
//
//  Created by Krzysztof Kostrzewa on 27/11/2020.
//  Adopted from [Vapor](https://github.com/vapor/vapor/blob/master/Sources/Vapor/HTTP/Headers/HTTPMediaType.swift)
//
...
///
struct HTTPMediaType: CustomStringConvertible {
